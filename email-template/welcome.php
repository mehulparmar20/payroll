                              ...
                              <table align="center" border="0" cellpadding="0" cellspacing="0" style='width: 100%; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #171E28; font-family: "Avenir","Segoe UI",Helvetica,Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji"; border: none;'>
                                <tr>
                                  <td class="center" style='font-family: "Avenir","Segoe UI",Helvetica,Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji"; border: none;' align="center" valign="middle">
                                      <img alt="Protein" src="http://new.windsonpayroll.com/admin/app/img/payroll.png" style=" width: 104px; height: 80px;">
                                  </td>
                                </tr>
                                <tr>
                                  <td style='font-family: "Avenir","Segoe UI",Helvetica,Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji"; border: none;' valign="middle">
                                ...
                                <tr>
                                  <td style='font-family: "Avenir","Segoe UI",Helvetica,Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji"; border: none;' valign="middle">
                                    <div class="header-title center" style="font-size: 18px; color: #171E28; line-height: 1.2;" align="center">
                                      <a href="https://www.windsonpayroll.com" title="Windson Payroll" style="color: #171E28; text-decoration: none;">Windson Payroll</a>
                                    </div>
                                  </td>
                                </tr>
                              </table>
                          ...
                          <tr>
                            <td style='font-family: "Avenir","Segoe UI",Helvetica,Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji"; border: none;' valign="top">
                              <div class="email-invite-title-container" style="margin: 32px 0;">
                                <div id="email-invite-title" style="color: #171E28; font-size: 26px; line-height: 32px; font-weight: 400;" align="center">Welcome to Windson Payroll! 🎉</div>
                              </div>
                              <div id="email-invite-message-container" style="max-width: 423px; min-width: 300px; font-weight: 400; margin: 0 auto;">
                                <div class="email-invite-message" style="font-family: 'Avenir-Book'; font-weight: 300; line-height: 30px; font-size: 22px; margin-bottom: 40px; color: #1f2021;" align="left">
                                    Thank you @name@ for making your first purchase with Windson payroll! We’re so glad that you found what you were looking for. Before you can set up your profile
                                  and add your details, you need to click the button below to verify your
                                  email.</div>
                          <tr>
                            <td style='font-family: "Avenir","Segoe UI",Helvetica,Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji"; border: none;' valign="top">
                                ...
                                <center>
                                  <table align="center" border="0" cellpadding="0" cellspacing="0" class="button-action-container" style='width: 100%; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #171E28; font-family: "Avenir","Segoe UI",Helvetica,Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji"; text-align: center; border: none;'>
                                    <tbody>
                                      <tr>
                                        <td style='font-family: "Avenir","Segoe UI",Helvetica,Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji"; border: none;' valign="top">
                                          <a class="mighty-btn-square-email-large mighty-btn-filled-secondary-email" href="@link@" title="Click Here to Join" style="-moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box; display: inline-block; line-height: 1; cursor: pointer; text-align: center; text-decoration: none; font-weight: 500; white-space: nowrap; min-width: 100px; font-size: 18px; -moz-border-radius: 4px; -webkit-border-radius: 4px; border-radius: 4px; background-color: #aaaaaa; color: #fff; border-color: #aaaaaa; border-style: solid; border-width: 17px 25px;">Click Here to Verify Eamil</a>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" id="email-footer" style='width: 100%; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #ABB0B9; font-family: "Avenir","Segoe UI",Helvetica,Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji"; text-align: center; border: none;' bgcolor="#f3f3f3">
              <tr>
                ...
                <td class="footer-content" style='font-family: "Avenir","Segoe UI",Helvetica,Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji"; padding-top: 20px; padding-bottom: 20px; border: none;' valign="top">
                  <div class="pdiv small" id="email-change-preferences" style='font-family: "Avenir","Segoe UI",Helvetica,Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji"; font-size: 12px; font-weight: 300; line-height: 1.5; margin: 0;'>You’ve been invited to join Protein |
                    <a href="#" target="" class="text-color-grey-link no-underline" title="Unsubscribe from all Protein notifications" style="color: #727C8B; fill: #727C8B; -moz-transition: color .2s ease-in-out,opacity .2s ease-in-out; -o-transition: color .2s ease-in-out,opacity .2s ease-in-out; -webkit-transition: color .2s ease-in-out,opacity .2s ease-in-out; transition: color .2s ease-in-out,opacity .2s ease-in-out; text-decoration: none;">Unsubscribe</a>
                  </div>
                </td>
                <td class="margins" style='font-family: "Avenir","Segoe UI",Helvetica,Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji"; width: 40px; border: none;' valign="top"></td>
              </tr>
                ...
                <td class="footer-content without-padding-top" style='font-family: "Avenir","Segoe UI",Helvetica,Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji"; padding-top: 0px; padding-bottom: 20px; border: none;' valign="top">
                  <div class="pdiv small sent-by-mighty" style='font-family: "Avenir","Segoe UI",Helvetica,Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji"; font-size: 12px; font-weight: 300; line-height: 1.5; margin: 0;'>Windson Payroll is powered by
                    <a href="https://www.nbptechnology.com" target="_blank" class="text-color-grey-link no-underline" title="NBP TECHNOLOGY LLP" style="color: #000000; fill: #727C8B; -moz-transition: color .2s ease-in-out,opacity .2s ease-in-out; -o-transition: color .2s ease-in-out,opacity .2s ease-in-out; -webkit-transition: color .2s ease-in-out,opacity .2s ease-in-out; transition: color .2s ease-in-out,opacity .2s ease-in-out; text-decoration: none;">NBP Technology LLP</a>
                    <br><center>Dharmaj-Ranoli Road, Dharmaj Anand Gj 388430 </center>
                  </div>
                </td>
              </tr>
            </table>
