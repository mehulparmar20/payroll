...
}(jQuery); /*!jRespond.js v 0.10 | Author: Jeremy Fields [jeremy.fields@viget.com], 2013 | License: MIT*/
! function(a, b, c) {
...
}(window.Zepto || window.jQuery, window, document); /*!FitVids 1.1*/
! function(t) {
 "use strict";
...
}, 1000); /*!Morphext - v2.3.2 - 2014-10-10*/
! function(a) {
 "use strict";
...
}(jQuery); /*!Magnific Popup - v1.0.0 - 2015-01-03 http://dimsemenov.com/plugins/magnific-popup/*/
! function(a) {
...
}(jQuery); /*!The Final Countdown for jQuery v2.0.4 (http://hilios.github.io/jQuery.countdown/)*/
! function(a) {
 "use strict";
...
! function(e, t, o, n) {
 ...
 function s(o, n) {
  d[o] && (H.before(o, f), y = 1, H.sectionName && (t.location.hash = d[o]), n ? (e(H.target).stop().scrollTop(l[o]), H.after(o, f)) : (e(H.target).stop().animate({
   scrollTop: l[o]
  }, H.scrollSpeed, H.easing), e(H.target).promise().done(function() {
   w = !1, H.after(o, f)
  })))
 }
 ...
 e.scrollify = function(n) {
  function i(t) {
   e(H.target).stop().animate({
    scrollTop: t
   }, H.scrollSpeed, H.easing)
  }
  ...
  e.easing.easeOutExpo = function(e, t, o, n, s) {
   ...
   init: function() {
    H.scrollbars ? (e(t).bind("mousedown", a.handleMousedown), e(t).bind("mouseup", a.handleMouseup), e(t).bind("scroll", a.handleScroll)) : e("body").css({
     overflow: "hidden"
    }), e(o).bind("DOMMouseScroll mousewheel", a.wheelHandler), e(o).bind("keydown", a.keyHandler)
   }
  }, h = {
   touches: {
    touchSTART: {
