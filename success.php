                            ...
                            <tr>
                                <td>
                                    <table width="220" border="0" cellpadding="0" cellspacing="0" align="left"
                                        ...
                                        <tbody>
                                        <tr>
                                            <td align="left"><img src="http://www.supah.it/dribbble/017/logo.png"
                ...
                <tr>
                    <td>
                        <table width="480" border="0" cellpadding="0" cellspacing="0" align="center"
                            ...
                            <tr>
                                <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #ff0000;  line-height: 18px;  vertical-align: top; padding:10px 0;"
                                    class="article">Beats RemoteTalk Cable
                                </td>
                                <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e;  line-height: 18px;  vertical-align: top; padding:10px 0;">
                            ...
                            <tr>
                                <td>
                                    <table width="220" border="0" cellpadding="0" cellspacing="0" align="left"
                                        ...
                                        <tr>
                                            <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                                Philip Brooks<br> Public Wales, Somewhere<br> New York NY<br> 4468,
                                                United States<br> T: 202-555-0133
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <table width="220" border="0" cellpadding="0" cellspacing="0" align="right"
                                        ...
                                        <tr>
                                            <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                                Credit Card<br> Credit Card Type: Visa<br> Worldpay Transaction ID: <a
                                                        href="#" style="color: #ff0000; text-decoration:underline;">4185939336</a><br>
                            ...
                            <tr>
                                <td>
                                    <table width="220" border="0" cellpadding="0" cellspacing="0" align="left"
                                        ...
                                        <tr>
                                            <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                                Sup Inc<br> Another Place, Somewhere<br> New York NY<br> 4468, United
                                                States<br> T: 202-555-0171
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
